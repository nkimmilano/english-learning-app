    ...
    drills: [
      {
        ...
        rcQuestions: [
          {
            question: 'What does the Little Red Hen want to make?',
            correctAnswer: 'A cake',
            options: ['A cake', 'Bread', 'A pie', 'Soup'],
            explanation: 'The hen finds raspberries and decides to make a cake with them.',
            questionType: 'literal',
          },
          {
            question: 'Why do the hen\'s friends refuse to help her?',
            correctAnswer: 'They are too busy watching TV',
            options: ['They are sleeping', 'They do not like cake', 'They are too busy watching TV', 'They are working in the garden'],
            explanation: 'The hen\'s lazy friends are watching TV and do not want to help with any of the work.',
            questionType: 'literal',
          },
          {
            question: 'What does the word "hard-working" tell us about the hen\'s character?',
            correctAnswer: 'She is willing to put in effort and not give up',
            options: ['She is always angry', 'She is willing to put in effort and not give up', 'She works very fast', 'She does not need any friends'],
            explanation: '"Hard-working" describes someone who consistently tries their best and does not avoid difficult tasks — the opposite of her lazy friends.',
            questionType: 'vocabulary',
          },
          {
            question: 'What lesson does this story teach?',
            correctAnswer: 'If you do not help with the work, you should not share the reward',
            options: ['It is better to work alone than with friends', 'Cake is the best food to make', 'If you do not help with the work, you should not share the reward', 'Watching TV is a waste of time'],
            explanation: 'This is a classic fable about fairness — those who refuse to help cannot expect to enjoy the results of someone else\'s hard work.',
            questionType: 'inference',
          },
        ],
      },
    ...
    drills: [
      {
        id: 'd1',
        type: 'video-comprehension',
        question: 'The Girl and the Ice Cream Truck',
        videoId: '1DeQVnSxcLk',
        videoDuration: '2:30',
        topic: 'story',
        readingLevel: 'b1',
        ...
        rcQuestions: [
          {
            question: 'What is the girl doing at the start of the story?',
            correctAnswer: 'Looking out her bedroom window',
            options: ['Playing outside in the garden', 'Looking out her bedroom window', 'Eating ice cream at the table', 'Walking down the street'],
            explanation: 'The story begins with the girl staring out her bedroom window, longing for summer.',
            questionType: 'literal',
          },
          {
            question: 'What does the girl see that excites her?',
            correctAnswer: 'An ice cream truck',
            options: ['A rainbow', 'An ice cream truck', 'Her friends playing outside', 'The sun coming out'],
            explanation: 'The girl spots an ice cream truck outside, which immediately captures her attention and excitement.',
            questionType: 'literal',
          },
          {
            question: 'What does the word "longing" mean as used in the story?',
            correctAnswer: 'Wanting something very much that you cannot have right now',
            options: ['Feeling very happy about something', 'Wanting something very much that you cannot have right now', 'Looking carefully at something far away', 'Waiting patiently for something to happen'],
            explanation: '"Longing" means a deep feeling of wanting something — here the girl deeply wishes for summer to arrive.',
            questionType: 'vocabulary',
          },
          {
            question: 'What does the girl\'s excitement about the ice cream truck suggest about her feelings?',
            correctAnswer: 'A small happy surprise can lift your mood even on a dull day',
            options: ['She has never eaten ice cream before', 'Ice cream trucks only come in summer', 'A small happy surprise can lift your mood even on a dull day', 'She is always happy and never feels sad'],
            explanation: 'The girl goes from feeling sad and wishing for summer to suddenly feeling joy — showing how a small unexpected pleasure can change how we feel.',
            questionType: 'inference',
          },
        ],
      },
