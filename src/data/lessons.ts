...
export const LESSONS: Lesson[] = [
...

  {
    ...
    requiredXP: 0,
    drills: [
      { id: 'd1', type: 'homophone', question: 'I left my bag ___ (at that location).', correctAnswer: 'there', options: ['there', 'their', "they're"], homophoneExplanation: 'There = location. Their = belonging to them. They\'re = they are.' },
      { id: 'd2', type: 'homophone', question: 'Have you finished ___ homework? (belonging to you)', correctAnswer: 'your', options: ['your', "you're"], homophoneExplanation: 'Your = belonging to you. You\'re = you are.' },
      { id: 'd3', type: 'homophone', question: 'The cat hurt ___ paw. (belonging to it)', correctAnswer: 'its', options: ['its', "it's"], homophoneExplanation: 'Its = belonging to it. It\'s = it is.' },
      { id: 'd4', type: 'homophone', question: 'I need ___ go to the store. (purpose/direction)', correctAnswer: 'to', options: ['to', 'too', 'two'], homophoneExplanation: 'To = towards / in order to. Too = also / excessively. Two = the number 2.' },
      { id: 'd5', type: 'homophone', question: 'She can ___ the music from outside.', correctAnswer: 'hear', options: ['hear', 'here'], homophoneExplanation: 'Hear = to perceive sound. Here = this place.' },
      { id: 'd6', type: 'homophone', question: 'I ___ the answer but forgot to say it.', correctAnswer: 'knew', options: ['knew', 'new'], homophoneExplanation: 'Knew = past tense of know. New = not old.' },
      { id: 'd7', type: 'homophone', question: 'Turn ___ and you\'ll see the school.', correctAnswer: 'right', options: ['right', 'write'], homophoneExplanation: 'Right = correct / direction. Write = to put words on paper.' },
      { id: 'd8', type: 'homophone', question: 'Do you know ___ she put the keys?', correctAnswer: 'where', options: ['where', 'wear', 'ware'], homophoneExplanation: 'Where = location. Wear = to have clothing on. Ware = goods for sale.' },
      { id: 'd9', type: 'homophone', question: 'The loud noise ___ me from my work.', correctAnswer: 'distracted', options: ['distracted', 'disstracted'], homophoneExplanation: 'Distracted is correct — one s, one t.' },
      { id: 'd10', type: 'homophone', question: 'I ate ___ much pizza last night.', correctAnswer: 'too', options: ['to', 'too', 'two'], homophoneExplanation: 'Too = excessively / also. To = towards. Two = the number 2.' },
    ],
  },

  {
    id: 'b2-homophones-advanced',
    zone: 'b2',
    category: 'Homophones',
    ...
    requiredXP: 0,
    drills: [
      { id: 'd1', type: 'homophone', question: 'The new policy will ___ everyone equally. (to have an effect on)', correctAnswer: 'affect', options: ['affect', 'effect'], homophoneExplanation: 'Affect (verb) = to have an influence on. Effect (noun) = the result or outcome.' },
      { id: 'd2', type: 'homophone', question: 'The ___ of the new law was felt immediately. (the result)', correctAnswer: 'effect', options: ['affect', 'effect'], homophoneExplanation: 'Effect (noun) = the result. Affect (verb) = to influence.' },
      { id: 'd3', type: 'homophone', question: 'Please ___ my invitation to dinner. (to say yes to)', correctAnswer: 'accept', options: ['accept', 'except'], homophoneExplanation: 'Accept = to receive or agree to something. Except = excluding / apart from.' },
      { id: 'd4', type: 'homophone', question: 'Everyone was invited ___ Tom. (not including)', correctAnswer: 'except', options: ['accept', 'except'], homophoneExplanation: 'Except = excluding. Accept = to receive something willingly.' },
      { id: 'd5', type: 'homophone', question: 'The red shoes ___ the dress perfectly. (to go well with)', correctAnswer: 'complement', options: ['complement', 'compliment'], homophoneExplanation: 'Complement = to complete or go well with something. Compliment = to praise someone.' },
      { id: 'd6', type: 'homophone', question: 'She gave me a kind ___ on my presentation. (praise)', correctAnswer: 'compliment', options: ['complement', 'compliment'], homophoneExplanation: 'Compliment = a nice thing said to someone. Complement = something that completes another.' },
      { id: 'd7', type: 'homophone', question: '___ book is this on the table? (belonging to whom)', correctAnswer: 'Whose', options: ['Whose', "Who's"], homophoneExplanation: 'Whose = belonging to whom. Who\'s = who is.' },
      { id: 'd8', type: 'homophone', question: 'Do you know ___ coming to the party tonight? (who is)', correctAnswer: "who's", options: ['whose', "who's"], homophoneExplanation: 'Who\'s = who is. Whose = belonging to whom.' },
      { id: 'd9', type: 'homophone', question: 'She ___ the ball to him across the field. (threw — past tense)', correctAnswer: 'passed', options: ['passed', 'past'], homophoneExplanation: 'Passed = past tense of pass (an action). Past = time before now, or beyond a point.' },
      { id: 'd10', type: 'homophone', question: 'In the ___, people did not have smartphones. (time before now)', correctAnswer: 'past', options: ['passed', 'past'], homophoneExplanation: 'Past = time that has already happened. Passed = past tense of the verb to pass.' },
    ],
  },
...

  {
    ...
    requiredXP: 0,
    drills: [
      { id: 'd1', type: 'memory-mashup', question: 'Listen and rebuild:', correctAnswer: 'The dog is sleeping on the sofa.', words: ['The', 'dog', 'is', 'sleeping', 'on', 'the', 'sofa.'] },
      { id: 'd2', type: 'memory-mashup', question: 'Listen and rebuild:', correctAnswer: 'She goes to school every morning.', words: ['She', 'goes', 'to', 'school', 'every', 'morning.'] },
      { id: 'd3', type: 'memory-mashup', question: 'Listen and rebuild:', correctAnswer: 'They are eating lunch in the park.', words: ['They', 'are', 'eating', 'lunch', 'in', 'the', 'park.'] },
      { id: 'd4', type: 'memory-mashup', question: 'Listen and rebuild:', correctAnswer: 'He forgot his umbrella at home.', words: ['He', 'forgot', 'his', 'umbrella', 'at', 'home.'] },
      { id: 'd5', type: 'memory-mashup', question: 'Listen and rebuild:', correctAnswer: 'The train leaves at half past seven.', words: ['The', 'train', 'leaves', 'at', 'half', 'past', 'seven.'] },
      { id: 'd6', type: 'memory-mashup', question: 'Listen and rebuild:', correctAnswer: 'We have never been to New York.', words: ['We', 'have', 'never', 'been', 'to', 'New', 'York.'] },
      { id: 'd7', type: 'memory-mashup', question: 'Listen and rebuild:', correctAnswer: 'Can you help me carry these bags?', words: ['Can', 'you', 'help', 'me', 'carry', 'these', 'bags?'] },
      { id: 'd8', type: 'memory-mashup', question: 'Listen and rebuild:', correctAnswer: 'My sister works at a big hospital.', words: ['My', 'sister', 'works', 'at', 'a', 'big', 'hospital.'] },
      { id: 'd9', type: 'memory-mashup', question: 'Listen and rebuild:', correctAnswer: 'It was raining when I left the office.', words: ['It', 'was', 'raining', 'when', 'I', 'left', 'the', 'office.'] },
      { id: 'd10', type: 'memory-mashup', question: 'Listen and rebuild:', correctAnswer: 'If you study hard you will pass the exam.', words: ['If', 'you', 'study', 'hard', 'you', 'will', 'pass', 'the', 'exam.'] },
    ],
  },
    ...
    drills: [
      {
        ...
        rcQuestions: [
          {
            question: 'How does the dog feel when he first finds the bone?',
            correctAnswer: 'Like the luckiest dog in the world',
            options: ['Scared and nervous', 'Like the luckiest dog in the world', 'Angry and hungry', 'Tired and bored'],
            explanation: 'The story describes the dog as feeling like the luckiest dog in the world when he finds the bone.',
            questionType: 'literal',
          },
          {
            question: 'What does the dog see when he looks into the water?',
            correctAnswer: 'His own reflection holding a bone',
            options: ['Another dog swimming', 'A fish with a bone', 'His own reflection holding a bone', 'A bigger bone at the bottom'],
            explanation: 'The dog sees his own reflection in the water and mistakes it for another dog with a bone.',
            questionType: 'literal',
          },
          {
            question: 'What does the word "greedy" mean in this story?',
            correctAnswer: 'Wanting more than you need',
            options: ['Being very generous', 'Wanting more than you need', 'Feeling very tired', 'Being kind to others'],
            explanation: 'Greedy means wanting more than your fair share — the dog already has a bone but wants the one he sees in the reflection too.',
            questionType: 'vocabulary',
          },
          {
            question: 'What happens when the dog opens his mouth to grab the other bone?',
            correctAnswer: 'He drops his own bone into the water',
            options: ['He catches two bones', 'He falls into the water', 'He drops his own bone into the water', 'He scares the other dog away'],
            explanation: 'When the dog barks at his reflection, he opens his mouth and drops the real bone he was carrying into the water.',
            questionType: 'literal',
          },
          {
            question: 'What lesson does this story teach?',
            correctAnswer: 'Being greedy can cause you to lose what you already have',
            options: ['Always share your food with others', 'Never walk near water with a bone', 'Being greedy can cause you to lose what you already have', 'Dogs are smarter than they look'],
            explanation: 'This Aesop fable warns that greed — wanting more when you already have enough — often leads to losing everything.',
            questionType: 'inference',
          },
        ],
      },
    ...
    drills: [
      {
        ...
        rcQuestions: [
          {
            question: 'What problem do the two hikers face in the story?',
            correctAnswer: 'They get stuck in bad weather',
            options: ['They get lost in the forest', 'They get stuck in bad weather', 'They run out of food', 'They fall and get injured'],
            explanation: 'The two hikers get caught in bad weather and must take shelter.',
            questionType: 'literal',
          },
          {
            question: 'Where do the hikers take shelter?',
            correctAnswer: 'Under an oak tree',
            options: ['In a cave', 'Under an oak tree', 'In a small cabin', 'Under a bridge'],
            explanation: 'The hikers shelter under an oak tree while the bad weather passes.',
            questionType: 'literal',
          },
          {
            question: 'What does the word "discover" mean as used in the story?',
            correctAnswer: 'To find out or learn something new',
            options: ['To hide something carefully', 'To find out or learn something new', 'To travel to a new place', 'To lose something important'],
            explanation: '"Discover" means to find or realise something — the hikers discover a truth about life through their unexpected experience.',
            questionType: 'vocabulary',
          },
          {
            question: 'What is the main lesson the hikers learn from their experience?',
            correctAnswer: 'Sometimes the best things are not what we originally wished for',
            options: ['Always check the weather before hiking', 'Big trees are the safest place to shelter', 'Sometimes the best things are not what we originally wished for', 'Hiking alone is more enjoyable than hiking with others'],
            explanation: 'The story\'s moral is that unexpected situations can lead to better outcomes than what we originally planned or hoped for.',
            questionType: 'inference',
          },
          {
            question: 'True, False, or Not Given: The two hikers had planned to shelter under the oak tree from the beginning.',
            correctAnswer: 'False',
            options: ['True', 'False', 'Not Given'],
            explanation: 'They got "stuck" in bad weather — this was unplanned. The shelter under the oak tree was not part of their original plan.',
            questionType: 'true-false-not-given',
          },
        ],
      },
    ...
    drills: [
      {
        id: 'd1',
        type: 'video-comprehension',
        question: 'The Fox and the Crow (first 2 minutes)',
        videoId: 'w6199XN1Gyk',
        videoDuration: '2:00',
        topic: 'story',
        readingLevel: 'b1',
        ...
        rcQuestions: [
          {
            question: 'What is the crow holding at the start of the story?',
            correctAnswer: 'A piece of cheese',
            options: ['A piece of bread', 'A piece of cheese', 'A worm', 'A nut'],
            explanation: 'The fox sees the crow sitting in a tree holding cheese in its beak.',
            questionType: 'literal',
          },
          {
            question: 'Why does the fox want the cheese?',
            correctAnswer: 'Because he is hungry',
            options: ['Because it belongs to him', 'Because he wants to give it to a friend', 'Because he is hungry', 'Because he wants to hide it'],
            explanation: 'The fox is described as hungry — that is why he wants to get the cheese from the crow.',
            questionType: 'literal',
          },
          {
            question: 'What does the fox do to try to get the cheese?',
            correctAnswer: 'He flatters the crow with compliments',
            options: ['He tries to climb the tree', 'He throws stones at the crow', 'He flatters the crow with compliments', 'He offers to trade food with the crow'],
            explanation: 'The fox uses flattery — telling the crow how beautiful and talented it is — as a trick to get what he wants.',
            questionType: 'literal',
          },
          {
            question: 'What does the word "flatter" mean in this story?',
            correctAnswer: 'To give someone excessive praise to get something from them',
            options: ['To make someone feel scared', 'To give someone excessive praise to get something from them', 'To share food fairly with someone', 'To argue loudly with someone'],
            explanation: 'Flattery is insincere praise used to manipulate someone — the fox does not truly believe his compliments, he just wants the cheese.',
            questionType: 'vocabulary',
          },
          {
            question: 'What can we infer about the fox\'s character from the first two minutes?',
            correctAnswer: 'He is clever and uses tricks rather than force',
            options: ['He is kind and generous', 'He is frightened of the crow', 'He is clever and uses tricks rather than force', 'He is too lazy to find his own food'],
            explanation: 'Rather than trying to physically get the cheese, the fox uses his intelligence and cunning to manipulate the crow — showing he is a clever schemer.',
            questionType: 'inference',
          },
        ],
      },
