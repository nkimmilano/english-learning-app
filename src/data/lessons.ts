    ...
    drills: [
      {
        id: 'd1',
        type: 'video-comprehension',
        question: 'New York City — The City That Never Sleeps',
        videoId: 'PEf_iBbFf1k',
        videoDuration: '4:02',
        topic: 'new-york',
        readingLevel: 'b1',
        ...
        rcQuestions: [
          {
            question: 'What is New York City\'s famous nickname?',
            correctAnswer: 'The Big Apple',
            options: ['The City of Dreams', 'The Big Apple', 'The Capital City', 'The Golden City'],
            explanation: 'New York City is famously known as "The Big Apple," a nickname used since the 1920s.',
            questionType: 'literal',
          },
          {
            ...
            explanation: 'New York City is made up of five boroughs: Manhattan, Brooklyn, Queens, The Bronx, and Staten Island.',
            questionType: 'literal',
          },
          {
            question: 'What does the word "iconic" mean as used in the video?',
            correctAnswer: 'Widely recognised and representing something important',
            options: ['Very tall or large', 'Very old and historic', 'Widely recognised and representing something important', 'Built from expensive materials'],
            explanation: '"Iconic" means something is so famous and recognisable that it has become a symbol of a place or idea.',
            questionType: 'vocabulary',
          },
          {
            question: 'Why is Times Square described as the "Crossroads of the World"?',
            correctAnswer: 'Because millions of people from all over the world visit and pass through it',
            options: ['Because it has the most traffic lights in the world', 'Because millions of people from all over the world visit and pass through it', 'Because it is located at the exact centre of Manhattan', 'Because it was built at the intersection of two major roads'],
            explanation: 'Times Square earns this nickname because of the enormous number of international visitors and its place at the heart of global culture and commerce.',
            questionType: 'inference',
          },
          {
            question: 'True, False, or Not Given: The Statue of Liberty was a gift from France.',
            correctAnswer: 'True',
            options: ['True', 'False', 'Not Given'],
            explanation: 'The Statue of Liberty was a gift from France to the United States, given in 1886 to celebrate friendship between the two nations.',
            questionType: 'true-false-not-given',
          },
        ],
      },
